    ...
    <div id="main-wrapper" class="main-wrapper">
        ...
        <div class="edu-course-area course-area-1 gap-tb-text">
            <div class="container">
                    ...
                    <div class="sorting-right">
                        <div class="layout-switcher">
                            ...
                            <ul class="switcher-btn">
                                <li>
                                    <NuxtLink to="/course/course-one" class="active"><i class="icon-53"></i></NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink to="/course/course-four"><i class="icon-54"></i></NuxtLink>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-4 col-xl-3" v-for="course in courses" :key="course.id">
                        <CourseTypeOne :course="course" extraClass="course-box-shadow" />
                    </div>
                </div>

                <div class="load-more-btn">
                    <button class="edu-btn" @click="loadMore" v-if="defaultNumberOfCourses < courseItems.length">
