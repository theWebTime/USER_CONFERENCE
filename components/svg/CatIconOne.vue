<template>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 34 40" height="40" width="34" alt="Online Degree">
        <path xmlns="http://www.w3.org/2000/svg"
            ...
            stroke="#1ab69d" stroke-width="2" stroke-miterlimit="10" stroke-linejoin="round"></path>
        <path xmlns="http://www.w3.org/2000/svg"
            ...
            stroke="#1ab69d" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
        <path xmlns="http://www.w3.org/2000/svg"
            ...
            stroke="#1ab69d" stroke-width="2" stroke-miterlimit="10"></path>
        <path xmlns="http://www.w3.org/2000/svg"
    ...
    <path xmlns="http://www.w3.org/2000/svg"
        ...
        stroke="#1ab69d" stroke-width="2" stroke-miterlimit="10"></path>
    <path xmlns="http://www.w3.org/2000/svg" d="M13.3472 14.5296L15.4656 12.4062" stroke="#1ab69d" stroke-width="2"
        stroke-miterlimit="10"></path>
    <path xmlns="http://www.w3.org/2000/svg" d="M10.9152 14.7009L8.73975 12.5205" stroke="#1ab69d" stroke-width="2"
        stroke-miterlimit="10"></path>
    <path xmlns="http://www.w3.org/2000/svg" d="M10.8582 17.7295L8.73975 19.8528" stroke="#1ab69d" stroke-width="2"
        stroke-miterlimit="10"></path>
    <path xmlns="http://www.w3.org/2000/svg" d="M13.2808 17.5576L15.4657 19.738" stroke="#1ab69d" stroke-width="2"
        stroke-miterlimit="10"></path>
    <path xmlns="http://www.w3.org/2000/svg"
        ...
        stroke="#1ab69d" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
</svg>
</template>
<script></script>